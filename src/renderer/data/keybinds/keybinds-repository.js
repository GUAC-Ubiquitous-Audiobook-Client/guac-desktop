...
exports.KeybindsRepositoryImpl = void 0;
var uuid_1 = require("uuid");
var electron_json_storage_1 = __importDefault(require("electron-json-storage"));
var KeybindsRepositoryImpl = /** @class */ (function () {
    function KeybindsRepositoryImpl() {
        this.STORAGE_KEY_DATA = "data_keybinds";
        this.keybindsData = {
            data: [
                {
                    id: "1",
    ...
    KeybindsRepositoryImpl.prototype._saveData = function (newData) {
    ...
    KeybindsRepositoryImpl.prototype.addKeybind = function () {
        var item = {
            id: uuid_1.v4(),
            action: "",
            shortcut: ""
    ...
    KeybindsRepositoryImpl.prototype.deleteKeybind = function (itemId) {
        var index = this.keybindsData.data.findIndex(function (item) { return item.id === itemId; });
        if (index !== -1) {
            this.keybindsData.data.splice(index, 1);
            this._saveData(this.keybindsData);
        }
    };
    return KeybindsRepositoryImpl;
}());
exports.KeybindsRepositoryImpl = KeybindsRepositoryImpl;
